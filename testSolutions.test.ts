...
describe("Sudoku-Solver", () => {
  ...
  const bigSudoku = [
    [1, 8, 5, 4, 0, 0, 0, 0, 10, 11, 12, 13, 0, 0, 0, 0],
    [2, 3, 6, 7, 0, 0, 0, 0, 1, 4, 5, 8, 0, 0, 0, 0],
    [11, 12, 13, 16, 0, 0, 0, 0, 2, 9, 14, 15, 0, 0, 0, 0],
    [9, 10, 14, 15, 0, 0, 0, 0, 3, 6, 7, 16, 0, 0, 0, 0],
    [3, 16, 1, 2, 0, 0, 0, 0, 11, 7, 10, 4, 0, 0, 0, 0],
    [6, 9, 8, 11, 0, 0, 0, 0, 5, 12, 13, 1, 0, 0, 0, 0],
    [4, 7, 12, 13, 0, 0, 0, 0, 14, 3, 15, 6, 0, 0, 0, 0],
    [5, 14, 15, 10, 0, 0, 0, 0, 8, 2, 16, 9, 0, 0, 0, 0],
    [13, 6, 3, 1, 0, 0, 0, 0, 9, 14, 4, 7, 0, 0, 0, 0],
    [7, 15, 9, 14, 0, 0, 0, 0, 12, 8, 6, 5, 0, 0, 0, 0],
    [16, 2, 11, 5, 0, 0, 0, 0, 15, 13, 10, 3, 0, 0, 0, 0],
    [8, 4, 10, 12, 0, 0, 0, 0, 16, 1, 2, 11, 0, 0, 0, 0],
    [15, 1, 2, 3, 0, 0, 0, 0, 7, 10, 9, 12, 0, 0, 0, 0],
    [10, 13, 7, 8, 0, 0, 0, 0, 6, 15, 11, 2, 0, 0, 0, 0],
    [14, 11, 16, 6, 0, 0, 0, 0, 1, 4, 5, 8, 0, 0, 0, 0],
    [12, 5, 4, 9, 0, 0, 0, 0, 13, 16, 1, 14, 0, 0, 0, 0]
]
  ...
  it("should return the false (Wrong Input 1)", () => {
  ...
  it("should return the false (Wrong Input 3)", () => {
